...
public class SparseCFGQueryLog {
    ...
    private boomerang.scene.sparse.eval.SparseCFGQueryLog.QueryDirection direction;
    ...
    public SparseCFGQueryLog(boolean retrievedFromCache, boomerang.scene.sparse.eval.SparseCFGQueryLog.QueryDirection direction) {
    ...
    public boomerang.scene.sparse.eval.SparseCFGQueryLog.QueryDirection getDirection() {
        return direction;
    }
